...
type Class struct {
	...
	BookFromUnit  uint      `json:"book_from_unit" form:"book_from_unit" gorm:"-" validate:"required"` // 课程 开始单元
	BookToUnit    uint      `json:"book_to_unit" form:"book_to_unit" gorm:"-" validate:"required"`     // 课程 结束单元
